...
def test_car_init():
    ...
    # edge cases
    # assert Car('O', 1, (1, 0), 1)._Car__length == 1
    # assert Car('foo', 2, (0, 0), 0)._Car__name == 'foo'
    # assert Car('A', 5, (-1, -1), 0)._Car__location == (-1, -1)

    # illegal values
    #assert Car('R', 0, (0, 0), 0)._Car__length != 0
    #assert Car('W', 1, (0, 0), -1)._Car__orientation != -1
